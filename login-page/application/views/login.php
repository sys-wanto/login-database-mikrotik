	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				...
				<form class="login100-form validate-form" name="loginUser" action="<?= base_url('login/do_login'); ?>" method="post" onSubmit="return doLoginUser()">
					<span class="login100-form-title p-b-59">
						Login Here.
					</span>

					<div class="wrap-input100 validate-input" data-validate="No Kamar is required">
						<span class="label-input100">No. Kamar</span>
						<input class="input100" type="text" name="no_kamar" placeholder="No. Kamar">
